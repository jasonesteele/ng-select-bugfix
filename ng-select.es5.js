...
var SelectComponent = /** @class */ (function () {
    ...
    SelectComponent.prototype.updatePosition = function () {
        ...
        var /** @type {?} */ dropHeight = this.dropdown ? this.dropdown.hostElement.nativeElement.firstElementChild.getBoundingClientRect().height : 0;
        var /** @type {?} */ windowHeight = window.innerHeight;
        var /** @type {?} */ top = spanRect.top - hostRect.top;
        var /** @type {?} */ bottom = hostRect.bottom + dropHeight;
