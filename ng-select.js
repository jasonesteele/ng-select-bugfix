...
class SelectComponent {
    ...
    updatePosition() {
        ...
        const /** @type {?} */ dropHeight = this.dropdown ? this.dropdown.hostElement.nativeElement.firstElementChild.getBoundingClientRect().height : 0;
        const /** @type {?} */ windowHeight = window.innerHeight;
        const /** @type {?} */ top = spanRect.top - hostRect.top;
        const /** @type {?} */ bottom = hostRect.bottom + dropHeight;
        this.isBelow = bottom < windowHeight;
        this.left = spanRect.left - hostRect.left;
        this.top = this.isBelow ? top + spanRect.height : top - dropHeight;
    }
    /**
     * @return {?}
     */
